...
class BankingPage:
    ...
    def login(self):
        ...
        Select(self.wait.until(EC.presence_of_element_located((By.ID, "userSelect")))).select_by_value("2")
    ...
    @allure.step("Шаг 4: Списание со счета")
    ...
    @allure.step("Шаг 6: Проверка транзакций")
    ...
    @allure.step("Шаг 8: Запись данных в CSV и прикрепление файла к отчету Allure")
